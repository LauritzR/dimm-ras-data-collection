...
//static bool is_poll_running = true;
static unsigned int sleep_ms = 10; //Sleep time in milliseconds
/*
...
/*IMC MSR STATUS, ADDRESS and MISC registers*/
static const u32 imc_msr_status[] = {
	0x425,0x429,0x42D,0x431,0x435,0x439,0x43D,0x441
};

static const u32 imc_msr_addr[] = {
	0x426,0x42A,0x42E,0x432,0x436,0x43A,0x43E,0x442
};


static const u32 imc_msr_misc[] = {
    0x427,0x42B,0x42F,0x433,0x437,0x43B,0x43F,0x443
};
...
struct sbridge_pvt {
	...
	struct pci_dev		*pci_ha, *pci_ta, *pci_ras, *pci_cerr[NUM_CHANNELS];
	struct pci_dev		*pci_tad[NUM_CHANNELS];
	int num_channels; 	/* inferred from Error devices exposed by IMC */
...
#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR0    0x2fb2  //IMC0 - Channel 0
#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR1	 0x2fb3	 //IMC0 - Channel 1
//#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR2	 0x2fb6  //IMC0 - Channel 2
//#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR3	 0x2fb7  //IMC3 - Channel 3
#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR4    0x2fd2  //IMC1 - Channel 0
#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR5	 0x2fd3	 //IMC1 - Channel 1
//#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR6	 0x2fd6  //IMC1 - Channel 2
//#define PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR7	 0x2fd7  //IMC1 - Channel 3
static const struct pci_id_descr pci_dev_descr_haswell[] = {
	...
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR0, 1, IMC0) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR1, 1, IMC0) },
	//{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR2, 1, IMC0) },
	//{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR3, 1, IMC0) },
	...
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR4, 1, IMC1) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR5, 1, IMC1) },
	//{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR6, 1, IMC1) },
	//{ PCI_DESCR(PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR7, 1, IMC1) },
...
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR0  0x6fb2
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR1	 0x6fb3
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR2	 0x6fb6
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR3	 0x6fb7
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR4  0x6fd2  //IMC1 - Channel 0
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR5	 0x6fd3	 //IMC1 - Channel 1
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR6	 0x6fd6  //IMC1 - Channel 2
#define PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR7	 0x6fd7  //IMC1 - Channel 3
...
static const struct pci_id_descr pci_dev_descr_broadwell[] = {
	...
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR0, 1, IMC0) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR1, 1, IMC0) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR2, 1, IMC0) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR3, 1, IMC0) },
	...
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR4, 1, IMC1) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR5, 1, IMC1) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR6, 1, IMC1) },
	{ PCI_DESCR(PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR7, 1, IMC1) },
...
static const struct pci_id_table pci_dev_descr_broadwell_table[] = {
	PCI_ID_TABLE_ENTRY(pci_dev_descr_broadwell, 13, 2, BROADWELL),
	{0,}			/* 0 terminated list. */
};
				 ...
				 struct sbridge_dev *sbridge_dev)
{
	...
	for (i = 0; i < sbridge_dev->n_devs; i++) {
		...
		case PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR0:
		case PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR1:
		case PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR4:
		case PCI_DEVICE_ID_INTEL_HASWELL_IMC_CHANNELERROR5:
			pvt->pci_cerr[pvt->num_channels] = pdev;
			pvt->num_channels++;
			sbridge_printk(KERN_ALERT,"adding a pci_corr type device \n");
			break;
		default:
			break;
		}
				 ...
				 struct sbridge_dev *sbridge_dev)
{
	...
	for (i = 0; i < sbridge_dev->n_devs; i++) {
		...
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_DDRIO0:
			 pvt->pci_ddrio = pdev;
			 break;
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR0: /*Support fetching corrected error counts automatically*/
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR4: //IMC1 - CHANNEL 0
			 pvt->pci_cerr[pvt->num_channels] = pdev;
			 pvt->num_channels++;
			 sbridge_printk(KERN_ALERT,"adding a pci_cerr type device: %02x:%02x.%d Channel discovered = %d\n",
					 	 	sbridge_dev->bus,PCI_SLOT(pdev->devfn), PCI_FUNC(pdev->devfn),pdev,pvt->num_channels);
			 break;
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR1:
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR5: //IMC1 - CHANNEL 1
			 pvt->pci_cerr[pvt->num_channels] = pdev;
			 pvt->num_channels++;
			 sbridge_printk(KERN_ALERT,"adding a pci_cerr type device: %02x:%02x.%d Channel discovered = %d\n",
					 	 	sbridge_dev->bus,PCI_SLOT(pdev->devfn), PCI_FUNC(pdev->devfn),pdev,pvt->num_channels);
		...
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR2:
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR6: //IMC1 - CHANNEL 2
			 pvt->pci_cerr[pvt->num_channels] = pdev;
			 pvt->num_channels++;
			 sbridge_printk(KERN_ALERT,"adding a pci_cerr type device: %02x:%02x.%d Channel discovered = %d\n",
					 	 	sbridge_dev->bus,PCI_SLOT(pdev->devfn), PCI_FUNC(pdev->devfn),pdev,pvt->num_channels);
			 break;
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR3:
		case PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CHANNELERROR7: //IMC1 - CHANNEL 3
			 pvt->pci_cerr[pvt->num_channels] = pdev;
			 pvt->num_channels++;
			 sbridge_printk(KERN_ALERT,"adding a pci_cerr type device: %02x:%02x.%d Channel discovered = %d\n",
					 	 	sbridge_dev->bus,PCI_SLOT(pdev->devfn), PCI_FUNC(pdev->devfn),pdev,pvt->num_channels);
...
/*
 *Polling function to read the RANK level counters
 */
...
static int sbridge_register_mci(struct sbridge_dev *sbridge_dev, enum type type)
{
	...
	default:
		sbridge_printk(KERN_INFO,"No processors were matched \n");
		break;
	}
...
static int __init sbridge_init(void)
{
	...
	if (rc >= 0) {
		...
		// Call the function to get the errorcount from PCIconfig space.
		//set the timer.

			kthread = kthread_create(sb_rd_err_log, NULL, "mykthread");
			if (IS_ERR(kthread)) {
				edac_dbg(2, "ERROR! KTHREAD sb_rd_err_log not running\n");
